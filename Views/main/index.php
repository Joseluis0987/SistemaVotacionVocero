...
<body>
    ...
    <div id="main">
        <h1>Bienvenido al sitio <?php echo $_SESSION['nombre'];?></h1>
        <?php
        if ($_SESSION['rol'] == 1) {
            ...
            ?>
                <div class="col">
                    <div class="card">
                        ...
                        ?>
                            <button class="btn btn-success m-0" data-bs-toggle="modal" data-bs-target="#resultado<?php echo $proceso->id;?>">Resultado</button>
                            ...
                            ?>
                                <a href="<?php echo constant('URL') . 'tarjeton/render/' . $proceso->id.'/'.$proceso->ficha; ?>" class="btn btn-warning">Tarjetones</a>
                            <?php
                        }
                        ?>
                    </div>
